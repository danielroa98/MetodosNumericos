...
read(*,*)opt
  ...
  case (3)
    WRITE(*,*) "It works as well"

  case default
    WRITE(*,*) "Please choose an option from the list"
...
SUBROUTINE exponentialRegression
  ...
  REAL :: fauxA0, realA0, a1, xIn, yIn, sT, sR, r, r2
  ...
  do count = 1, nR
    ...
    sR = sR + (log(y(count)) - (fauxA0+a1*x(count)))**2
